...
static WldhDBManager *stat_dataBaseManager = nil;

@implementation WldhDBManager
...
+ (WldhDBManager *)shareInstance
{
    @synchronized(self)
    {
        ...
        {
            stat_dataBaseManager = [[WldhDBManager alloc] init];
        }
...
- (BOOL)createGloabDatabase
{
    @synchronized(self.globalDBQueue)
    {
        ...
        NSString *filePath = [basePath stringByAppendingPathComponent:@"global.db"];
        self.globalDBQueue = [FMDatabaseQueue databaseQueueWithPath:filePath];
