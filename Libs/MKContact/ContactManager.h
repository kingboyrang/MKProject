...
@interface ContactManager : NSObject//<RCIMFriendsFetcherDelegate, RCIMUserInfoFetcherDelegagte>
{
    ...
    NSString * _phoneNumStrings;                      //电话号码字符串
    NSMutableArray * _kcFriendNumbers;                //kc好友集合
    NSDictionary * _kcYundic;
    NSString * _tokenstr;
...
typedef enum
{
    kcFriendTypewei = 0,            //未获取
    kcFriendTypegeted = 1,          //已经拉取
    kcFriendTypegetedthree = 2,
}kcFriendType;
...
@property(nonatomic,retain) NSString * phoneNumStrings;
@property(nonatomic,retain) NSMutableArray *kcFriendNumbers;    // 一个用户的所有好友列表
@property(nonatomic,retain) NSDictionary *kcYundic;//kc好友
@property(nonatomic,retain) NSDictionary *rcYundic;//融云好友
@property(nonatomic,assign) BOOL                  ishuoqukc;
@property(nonatomic,assign) kcFriendType  kcfriendtype;
@property(nonatomic,retain) NSString *tokenstr;           //token值
@property(nonatomic, strong) NSMutableArray *allFriendsArray;//im好友
@property(nonatomic, assign) BOOL isRestore;//恢复联系人状态
